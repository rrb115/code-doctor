...
const ANIMATION_COMPLETED_KEY = "code-doctor-animation-completed";
const COMMAND = "npx -y code-doctor@latest .";
const GITHUB_URL = "https://github.com/millionco/code-doctor";
      ...
      {state.showHeader && (
        <FadeIn>
          ...
          <div className="flex items-center gap-2">
            <img src="/favicon.svg" alt="Code Doctor" width={24} height={24} />
            code-doctor
          </div>
